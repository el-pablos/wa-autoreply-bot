...
class BotSettingSeeder extends Seeder
{
    public function run(): void
    {
        $settings = [
            ...
            ['key' => 'ai_reply_enabled', 'value' => 'false', 'description' => 'Aktifkan balasan AI'],
            ['key' => 'ai_model', 'value' => 'groq/llama-3.1-8b-instant', 'description' => 'Model AI default'],
            ['key' => 'ai_system_prompt', 'value' => 'Kamu adalah asisten WA bisnis yang ramah, singkat, dan to the point.', 'description' => 'System prompt AI'],
            ['key' => 'webhook_enabled', 'value' => 'false', 'description' => 'Aktifkan webhook outbound'],
            ['key' => 'alert_enabled', 'value' => 'false', 'description' => 'Aktifkan alerting bot'],
            ['key' => 'escalation_enabled', 'value' => 'false', 'description' => 'Aktifkan escalation saat kondisi tertentu'],
